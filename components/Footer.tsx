export default function Footer() {
  return (
    <footer className="bg-dark text-white/50 py-12 px-4">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 flex-wrap">
        <div className="font-cormorant text-[1.3rem] font-light text-white/75 tracking-widest">
        ...
        <div className="text-[0.75rem] tracking-wider text-center md:text-right italic text-blush">
